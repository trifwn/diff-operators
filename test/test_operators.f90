module test_operators
   ...
   real(real64), parameter ::  dx = 0.01 
   real(real64), parameter ::  dy = 0.01
   real(real64), parameter ::  dz = 0.01
   real(real64), parameter ::  tol = 1.0e-8
contains
         ...
         do l = 1, nz
            do k = 1, ny
               do j = 1, nx
                  ...
                  scalar_df_analytic(j,k,l) = 2.0 * x
               end do
            end do
         end do
      ! endif 
         ...
         do l = 1, nz
            do k = 1, ny
               do j = 1, nx
                  ...
                  z = real(l, real64) * dz
                  f(j,k,l) = x*x + y*y + z*z
                  analytic_jac(1,j,k,l) = 2.0 * x
                  analytic_jac(2,j,k,l) = 2.0 * y
                  analytic_jac(3,j,k,l) = 2.0 * z
               end do
            end do
         end do
         ...
         do l = 1, nz
            do k = 1, ny
               do j = 1, nx
                  ...
                  ! EQ 1: f₁ = x² + y² + z²
                  f(1,j,k,l) = x*x + y*y + z*z
                  analytic_jac(1,1,j,k,l) = 2.0 * x   ! ∂f₁/∂x
                  analytic_jac(1,2,j,k,l) = 2.0 * y   ! ∂f₁/∂y
                  analytic_jac(1,3,j,k,l) = 2.0 * z   ! ∂f₁/∂z
                  ...
                  ! EQ 3: f₃ = x + y + z
                  f(3,j,k,l) = x + y + z
                  analytic_jac(3,1,j,k,l) = 1.0      ! ∂f₃/∂x
                  analytic_jac(3,2,j,k,l) = 1.0      ! ∂f₃/∂y
                  analytic_jac(3,3,j,k,l) = 1.0      ! ∂f₃/∂z
   ...
   subroutine test_differential_operators_difficult(total_tests, passed_tests)
      ...
      integer :: j, k, l
      logical :: test_passed
      real(real64) :: rel_tolerance = 0.05
